...
from aluno.views import aluno_criar,index,aluno_listar,aluno_editar,aluno_remover,curso_listar,cidade_listar,curso_criar,cidade_criar,curso_editar,curso_remover,cidade_editar,cidade_remover
